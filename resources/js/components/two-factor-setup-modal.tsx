                ...
                <>
                    ...
                    <div className="relative flex w-full items-center justify-center">
                        ...
                        <span className="relative bg-card px-2 py-1">
                            Ó ingresa el código manualmente
                        </span>
                    </div>
    ...
    const modalConfig = useMemo<{
        ...
        if (showVerificationStep) {
            return {
                ...
                description:
                    'Introduce el código OTP generado por tu app de autenticación para verificar la configuración de la autenticación de dos factores.',
