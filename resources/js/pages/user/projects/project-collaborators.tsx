...
import ProjectCollaboratorsModal from '@/components/user/projects/ProjectCollaboratorsModal';
import UserCollaboratorItem from '@/components/user/projects/UserCollaboratorItem';
import AppLayout from '@/layouts/app-layout';
import projectCollaborators from '@/routes/project-collaborators';
import projects from '@/routes/projects';
import { BreadcrumbItem, PaginationType, Project, UserData } from '@/types';
